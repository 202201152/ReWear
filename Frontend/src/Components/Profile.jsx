            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 bg-white border rounded-xl p-6 shadow-lg">
                    <div className="text-center">
                        <label htmlFor="profileImage" className="cursor-pointer">
                            {previewImage ? (
                                ...
                                <div className="w-28 h-28 rounded-full mx-auto bg-gray-300 border-4 border-blue-500 flex items-center justify-center text-4xl text-gray-600">
                                    📷
                                </div>
                            )}
                            <input
                        ...
                        <h2 className="mt-4 text-2xl font-bold text-blue-700">{username}</h2>
                    ...
                    <form onSubmit={submitHandler} noValidate className="mt-6 space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                className={`w-full bg-gray-100 text-black rounded-lg px-4 py-2 mt-1 outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.username ? 'border border-red-500' : ''}`}
                                value={username}
                        ...
                        <div>
                            ...
                            <input
                                type="email"
                                className={`w-full bg-gray-100 text-black rounded-lg px-4 py-2 mt-1 outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.email ? 'border border-red-500' : ''}`}
                                value={email}
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                className="w-full bg-gray-100 text-black rounded-lg px-4 py-2 mt-1 outline-none focus:ring-2 focus:ring-blue-500 transition"
                                value={password}
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                className={`w-full bg-gray-100 text-black rounded-lg px-4 py-2 mt-1 outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.confirmPassword ? 'border border-red-500' : ''}`}
                ...
                <div className="lg:col-span-2 flex flex-col space-y-8">
                    <div className="bg-white border rounded-xl p-6 shadow-lg">
                        <h3 className="text-2xl font-bold mb-4 text-blue-600">Your Products</h3>
                    ...
                    <div className="bg-white border rounded-xl p-6 shadow-lg">
                        <h3 className="text-2xl font-bold mb-4 text-blue-600">Requests</h3>
                        {requests.length === 0 ? (
                                    ...
                                    <li key={req.id} className="bg-gray-100 p-4 rounded-lg flex justify-between items-center shadow">
                                        <div>
                                            <p className="font-medium text-gray-800">
                                                <span className="text-blue-600">{req.requester}</span> requested your <strong>{req.item}</strong>
                                            </p>
